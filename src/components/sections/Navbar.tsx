		...
		<>
			<header className={"px-6 md:px-8 lg:px-10 py-0 md:py-4 lg:py-6 fixed top-0 w-full z-50"}>
				<nav className={"relative w-full flex justify-between items-center box-border"}>
					...
					<div
						className="flex flex-col items-end sm:block left-0 sm:relative z-60 w-full :w-[clamp(326px,45vw,550px)]">
			...
			<button
				...
				className={`fixed top-4 lg:top-6 right-8 lg:right-10 z-70 flex items-center gap-2 ${isOpen ? "bg-warm-cream text-walnut-shadow border-warm-cream" : "border-dotted"} md:hidden px-[1em] py-[0.4em] xs:px-[1.5em] xs:py-[0.6em] md:px-[1.8em] md:py-[0.9em] border-[1.4px] rounded-full cursor-pointer transition-all duration-200`}
			>
				<div
